...
from kgit.generation.alternative_generator import AlternativeGenerator
...
TEST_RELATIONS = [
    ...
    ("Who", "a character of", "sch__character"),
...
def main():
    ...
    save_dir = os.path.join(args.out_path, "kr2")
